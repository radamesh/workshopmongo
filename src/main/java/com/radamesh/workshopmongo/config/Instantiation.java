...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Post post = new Post(null, sdf.parse("20/09/1980"), "", "", new AuthorDTO(mariana));
        Post post1 = new Post(null, sdf.parse("31/07/2025"), "Dicas da Viagem", "quais a melhores dicas para viajar", new AuthorDTO(mariana));
        ...
        leandro.getPosts().add(post3);
        userRepository.saveAll(Arrays.asList(mariana, guilherme, leandro));
    }
}
